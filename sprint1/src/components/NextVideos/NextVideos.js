  ...
  render() {
    ...
    const videos = [
      ...
      },
      {
        ...
        thumbnail: require('../../assets/images/video-list-2.jpg'),
      },
      {
        id: 3,
        author: 'Lizzie Burton',
        title: 'Travel Health Useful Medical Information For',
        thumbnail: require('../../assets/images/video-list-3.jpg'),
      },
      {
        id: 4,
        author: 'Emily Harper',
        title: 'Cheap Airline Tickets Great Ways To Save',
        thumbnail: require('../../assets/images/video-list-4.jpg'),
      },
      {
        id: 5,
        author: 'Ethan Owen',
        title: 'Take A Romantic Break In A Boutique Hotel',
        thumbnail: require('../../assets/images/video-list-5.jpg'),
      },
      {
        id: 6,
        author: 'Lydia Perez',
        title: 'Choose The Perfect Accommodations',
        thumbnail: require('../../assets/images/video-list-6.jpg'),
      },
      {
        id: 7,
        author: 'Timothy Austin',
        title: 'Cruising Destination Ideas',
        thumbnail: require('../../assets/images/video-list-7.jpg'),
      },
      {
        id: 8,
        author: 'Scotty Cranmer',
        title: 'Train Travel On Track For Safety',
        thumbnail: require('../../assets/images/video-list-8.jpg'),
      },
    ]
